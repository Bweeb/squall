...
describe Squall::VirtualMachine do
  ...
  describe "#show" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.show(404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#build" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.build(404, :template_id => 1) }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end
  ...
  describe "#edit" do
    ...
    it "404s on not found" do
      expect { @virtual_machine.edit(404, :label => 1) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#change_owner" do
    ...
    it "404s on not found" do
      expect { @virtual_machine.change_owner(404, 1) }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end
    ...
    pending "this should raise a 422 on OnApp's side, but it's currently raising a 500 which causes HTTParty to explode, see README (and update when fixed)" do
      it "returns error on unknown user" do
        expect { @virtual_machine.change_owner(1, 2) }.to raise_error(Faraday::Error::ClientError)
        @virtual_machine.success.should be_false
      end
    end
  ...
  describe "#change_password" do
    ...
    it "404s on not found" do
      expect { @virtual_machine.change_password(404, 'password') }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end
  ...
  describe "#set_ssh_keys" do
    ...
    it "404s on not found" do
      expect { @virtual_machine.set_ssh_keys(404) }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end
  ...
  describe "#migrate" do
    ...
    it "404s on not found" do
      expect { @virtual_machine.migrate(404, :destination => 1) }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end

    it "404s on unknown destination" do
        expect { @virtual_machine.migrate(1, :destination => 404) }.to raise_error(Faraday::Error::ResourceNotFound)
        @virtual_machine.success.should be_false
    end
  ...
  describe "#set_vip" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.set_vip(404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#delete" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.delete(404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#resize" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.resize(404, :memory => 1) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#suspend" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.suspend(404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#unlock" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.unlock(404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#startup" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.startup(404) }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end
  ...
  describe "#shutdown" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.shutdown(404) }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end
  ...
  describe "#stop" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.stop(404) }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end
  ...
  describe "#reboot" do
    ...
    it "returns not found for invalid virtual_machines" do
      expect { @virtual_machine.reboot(404) }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end
  ...
  describe "#segregate" do
    ...
    it "404s on not found" do
      expect { @virtual_machine.segregate(404, 1) }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end

    it "returns 404 on unknown target vm id" do
      expect { @virtual_machine.segregate(1, 404) }.to raise_error(Faraday::Error::ResourceNotFound)
      @virtual_machine.success.should be_false
    end
  ...
  describe "#console" do
    ...
    it "returns not found for invalid virtual_machines" do
      pending "broken on OnApp (returning 500)" do
        expect { @virtual_machine.console(404) }.to raise_error(Faraday::Error::ResourceNotFound)
        @virtual_machine.success.should be_false
      end
    end
  ...
  describe "#stats" do
    ...
    it "returns not found for invalid virtual_machines" do
      pending "broken on OnApp (returning 500)" do
        expect { @virtual_machine.stats(404) }.to raise_error(Faraday::Error::ResourceNotFound)
        @virtual_machine.success.should be_false
      end
    end
