...
describe Squall::Role do
  ...
  describe "#show" do
    ...
    it "returns 404 for invalid id" do
      expect { @role.show(404) }.to raise_error(OnApp::NotFoundError)
    end
  ...
  describe "#edit" do
    ...
    it "returns 404 for invalid id" do
      expect { @role.edit(404) }.to raise_error(OnApp::NotFoundError)
    end
  ...
  describe "#delete" do
    ...
    it "returns not found for invalid user" do
      expect { @role.delete(5) }.to raise_error(OnApp::NotFoundError)
    end
