...
describe Squall::User do
  ...
  describe "#show" do
    ...
    it "returns not found for invalid users" do
      expect { @user.show(404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#delete" do
    ...
    it "returns NotFound for missing user" do
      expect { @user.delete(404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  end
  ...
  describe "#virtual_machines" do
    ...
    it "404s on not found" do
      expect { @user.virtual_machines(404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#hypervisors" do
    ...
    it "404s on not found" do
      expect { @user.hypervisors(404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#data_store_zones" do
    ...
    it "404s on not found" do
      pending "Broken on OnApp: returns success despite non-existent user" do
        expect { @user.data_store_zones(2532564353245) }.to raise_error(Faraday::Error::ResourceNotFound)
      end
    end
  ...
  describe "#network_zones" do
    ...
    it "404s on not found" do
      pending "Broken on OnApp: returns success despite non-existent user" do
        expect { @user.network_zones(2532564353245) }.to raise_error(Faraday::Error::ResourceNotFound)
      end
    end
  ...
  describe "#limits" do
    ...
    it "404s on not found" do
      expect { @user.limits(438768534623) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
