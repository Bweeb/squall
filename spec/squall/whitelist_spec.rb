...
describe Squall::Whitelist do
  ...
  describe "#show" do
    ...
    it "returns not found for invalid whitelists" do
      expect { @whitelist.show(1, 404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#create" do
    ...
    it "raises an error for an invalid user id" do
      expect { @whitelist.create(404, @valid) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  ...
  describe "#edit" do
    ...
    it "raises an error for an invalid whitelist id" do
      expect { @whitelist.edit(1, 404, @valid) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  end
  ...
  describe "#delete" do
    ...
    it "returns NotFound for missing user" do
      expect { @whitelist.delete(1, 404) }.to raise_error(Faraday::Error::ResourceNotFound)
    end
  end
